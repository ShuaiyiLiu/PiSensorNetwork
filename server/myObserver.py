"""
Re-implemetation of FileLogObserver and PythonLoggingObserver to support desired
logging format.
"""
...
class MyPythonLoggingObserver(object):
    """
    Output twisted messages to Python standard library L{logging} module.
